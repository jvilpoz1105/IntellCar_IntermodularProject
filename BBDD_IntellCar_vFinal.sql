...
CREATE TABLE model_spec(
    ...
    sp_key VARCHAR(50) NOT NULL,
    sp_value VARCHAR(100) NOT NULL,
    measurement_unit VARCHAR(20),
    sp_model INT NOT NULL,
    FOREIGN KEY (sp_model) REFERENCES car_model(model_id) ON DELETE CASCADE
);
...
CREATE TABLE engine_spec(
    ...
    sp_value VARCHAR(100) NOT NULL,
    measurement_unit VARCHAR(20),
    sp_engine INT NOT NULL,
    FOREIGN KEY (sp_engine) REFERENCES car_engine(engine_id) ON DELETE CASCADE
);
